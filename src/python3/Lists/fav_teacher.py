...
fav_teachers = []
fav_teachers.append(
    input("Enter the name of your favourite teacher:\n").title())
fav_teachers.append(
    input("Enter the name of your favourite teacher:\n").title())
fav_teachers.append(
    input("Enter the name of your favourite teacher:\n").title())
...
print(
    f"Your favourite teachers in alphabetical order are {sorted(fav_teachers)}\n")
print(
    f"Your favourite teachers in reverse alphabetical order are {sorted(fav_teachers, reverse=True)}\n")
print(
    f"Your two most favourite teachers are {fav_teachers[0]} and {fav_teachers[1]}\n")
...
fav_teachers.insert(0, input(
    f"Oops, {tmp} is no longer your first favorite teacher. Who is your new favorite teacher:\n").title())
